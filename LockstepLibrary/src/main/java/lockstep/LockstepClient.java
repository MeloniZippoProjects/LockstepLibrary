...
public abstract class LockstepClient<Command extends Serializable> implements Runnable
{
    ...
    private void handshake()
    {
        ...
        )
        {
            ...
            this.executionFrameQueues.put(hostID, new ExecutionFrameQueue(executionQueueBufferSize, helloReply.firstFrameNumber, hostID, cyclicExecutionLatch));
            ...
            {
                ExecutionFrameQueue executionFrameQueue = new ExecutionFrameQueue(executionQueueBufferSize, helloReply.firstFrameNumber, clientID, cyclicExecutionLatch);
