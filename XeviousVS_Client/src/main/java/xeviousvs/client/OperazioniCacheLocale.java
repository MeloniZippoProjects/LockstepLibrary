...
public class OperazioniCacheLocale {
    ...
    public static void ripristinaCache(XeviousVS_Client interfaccia, ModelloGioco modelloGioco, VistaGioco vistaGioco) {
    ...
    private static void ripristinaCachePartita(DatiCachePartita datiCachePartita, XeviousVS_Client interfaccia, ModelloGioco modelloGioco, VistaGioco vistaGioco) {
